    ...
    <div className="min-h-screen">
      <header className="sticky top-0 z-30 border-b border-ink-100/80 bg-white/95 backdrop-blur-md">
        <div className="page-container flex h-16 items-center gap-3 px-4 sm:px-6 lg:px-8">
          ...
          <Link to="/talent-pools" className="flex shrink-0 items-center gap-2.5">
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-3">
            ...
            <Link to="/notifications" className="focus-ring relative rounded-full border border-ink-200 bg-white p-2.5 text-ink-600 shadow-soft" aria-label={`${unread} unread notifications`}>
            ...
            <div className="hidden items-center gap-3 sm:flex">
              ...
              <div className="text-left">
                <p className="text-sm font-semibold text-ink-900">{clientProfile.name}</p>
